...
//base url
String url =
    'https://transawy.com/'; //please add '/' at the end of the url as 'https://yourwebsite.com/'
    // 'https://taxi-madina.com/'; //please add '/' at the end of the url as 'https://yourwebsite.com/'
String mapkey = 'AIzaSyCC2reTxxdUBtaAXOlDiyDoypwa0DCHxes';
...
sendCharge(amount) async {
  try {
    var response = await http.post(
        Uri.parse('${url}api/v1/payment/wallet/charge-wallet-request'),
        headers: {
          'Authorization': 'Bearer ${bearerToken[0].token}',
          'Content-Type': 'application/json'
        },
